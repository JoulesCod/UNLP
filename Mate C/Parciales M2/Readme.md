...
<br>**Desafío:** No puedes simplemente sumar números; debes trabajar con expresiones como $y_p(t) = \frac{a}{k^2 - \omega^2} \cos(\omega t)$, lo que requiere mucha precisión en el manejo de las constantes.
